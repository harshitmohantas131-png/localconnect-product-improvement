  ...
  return (
    <div>
      <div className="hero-section" style={{marginBottom: '3rem'}}>
        ...
        <p className="card-description" style={{fontSize: '1.2rem'}}>Your neighborhood's digital hub for staying connected, organizing events, and trading items.</p>
      </div>
      ...
      <div className="card">
        ...
        <div className="metrics-grid">
          ...
          <div className="metric-card">
            ...
            <span className="metric-label">Events Planned</span>
          </div>
          <div className="metric-card">
            <span className="metric-value">{metrics.activeMarketItems}</span>
      ...
      <div className="card">
        <h2 className="card-title">Community Status</h2>
        <p className="card-description">This dashboard provides a high-level overview of our community engagement and activity metrics.</p>
      </div>
    </div>
  );
};
